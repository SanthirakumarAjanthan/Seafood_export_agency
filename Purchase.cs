    ...
    public partial class Purchase : Form
    {
        ...
        private void orderid()
        {
            ...
            try
            {
                ...
                conn.Open();
                string Query = "SELECT max(purch_ID) FROM Purchase_Details";
        ...
        private void Purchase_Load(object sender, EventArgs e)
        {
            ...
            // TODO: This line of code loads data into the 'exportDataSet2.supplier' table. You can move, or remove it, as needed.
            this.supplierTableAdapter.Fill(this.exportDataSet2.supplier);
        ...
        private void search()
        {
            ...
            using (SqlConnection sqlCon = new SqlConnection(connectionString))
            {
                ...
                if (DR1.Read())
                {
                    lblbprice.Text = DR1.GetValue(3).ToString();
        ...
        private void puech_det()
        {
            try
            {
                ...
                {
                    sqlCon.Open();
                    string query = "INSERT INTO Purchase_Details (purch_ID,Sup_ID,pro_id,Proname,P_Qty,U_price,p_tot) VALUES (@purch_ID,@Sup_ID,@pro_id,@Proname,@P_Qty,@U_price,@p_tot)";
        ...
        private void puech_det_del()
        {
            try
            {
                ...
                {
                    sqlCon.Open();
                    string query = "DELETE FROM Purchase_Details WHERE purch_ID = @id and pro_id=@pro_id";
                    SqlCommand sqlCmd = new SqlCommand(query, sqlCon);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    sqlCon.Open();
                    string query = "INSERT INTO purchase (purch_ID,sup_id,date,total,Status) VALUES (@purch_ID,@sup_id,@date,@total,@Status)";
                    SqlCommand sqlCmd = new SqlCommand(query, sqlCon);
                    sqlCmd.Parameters.AddWithValue("@purch_ID", lblprch.Text);
                    sqlCmd.Parameters.AddWithValue("@sup_id", comboBox1.SelectedValue);
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            {
                sqlCon.Open();
                SqlDataAdapter sqlDa = new SqlDataAdapter("SELECT * FROM purchase WHERE date between '" + dateTimePicker2.Value.ToString("dd/MM/yyyy") + "' AND '" + dateTimePicker3.Value.ToString("dd/MM/yyyy") + "'", sqlCon);
                sqlDa.Fill(dtbl);
                dataGridView2.DataSource = dtbl;
            }
        ...
        private void dataGridView2_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                {
                    sqlCon.Open();
                    SqlDataAdapter sqlDa = new SqlDataAdapter("SELECT * FROM Purchase_Details WHERE purch_ID = '" + row.Cells[1].Value.ToString() + "'", sqlCon);
                    sqlDa.Fill(dtbl);
