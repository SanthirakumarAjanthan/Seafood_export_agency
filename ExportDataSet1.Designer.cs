...
namespace Export_agency {
    ...
    public partial class ExportDataSet1 : global::System.Data.DataSet {
        ...
        public partial class categoryDataTable : global::System.Data.TypedTableBase<categoryRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public categoryRow AddcategoryRow(string catname, string description) {
            ...
            private void InitClass() {
                ...
                this.columncatno.AutoIncrement = true;
                this.columncatno.AutoIncrementSeed = -1;
                this.columncatno.AutoIncrementStep = -1;
...
namespace Export_agency.ExportDataSet1TableAdapters {
    ...
    public partial class categoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[category] WHERE (([catno] = @Original_catno) AND ((@IsNull_cat" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[category] ([catname], [description]) VALUES (@catname, @descri" +
                "ption);\r\nSELECT catno, catname, description FROM category WHERE (catno = SCOPE_I" +
                "DENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[category] SET [catname] = @catname, [description] = @description WHERE (([catno] = @Original_catno) AND ((@IsNull_catname = 1 AND [catname] IS NULL) OR ([catname] = @Original_catname)) AND ((@IsNull_description = 1 AND [description] IS NULL) OR ([description] = @Original_description)));
SELECT catno, catname, description FROM category WHERE (catno = @catno)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@catno", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "catno", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Fill(ExportDataSet1.categoryDataTable dataTable) {
        ...
        public virtual ExportDataSet1.categoryDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ExportDataSet1.categoryDataTable dataTable = new ExportDataSet1.categoryDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ExportDataSet1.categoryDataTable dataTable) {
        ...
        public virtual int Delete(int Original_catno, string Original_catname, string Original_description) {
        ...
        public virtual int Insert(string catname, string description) {
            if ((catname == null)) {
        ...
        public virtual int Update(string catname, string description, int Original_catno, string Original_catname, string Original_description, int catno) {
            if ((catname == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[2].Value = ((int)(Original_catno));
            if ((Original_catname == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[7].Value = ((int)(catno));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string catname, string description, int Original_catno, string Original_catname, string Original_description) {
            return this.Update(catname, description, Original_catno, Original_catname, Original_description, Original_catno);
        }
    }
